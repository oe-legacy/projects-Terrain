...
which scene subnodes are rendered to. The \class{PostProcessNode} also
holds another \class{FrameBuffer} where the final image can be
...
is any integer, is seen, then the \class{FrameBuffer}'s \textit{N}'th
