...
The result can be seen on \reffig{fig:dofMotionBlur} where hill in the
...
\caption{The horizontally blurring depth of field shader.}
\end{listing}
...
% Next step is merge, blitting of the depth buffer to post process
% subscene graphs
